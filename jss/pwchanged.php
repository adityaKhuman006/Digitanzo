...
<body id="contact" bgcolor="#ccc" class="inner_page" data-spy="scroll" data-target="#navbar-wd" data-offset="98">
	...
	<div class="main-content">
		...
		<p class="main-content__body" data-lead-id="main-content-body"> Your Password has been successfully Changed. Login Now</p>
	</div>
	<div>
	     <input class="btn btn-primary" type="button" onclick="location.href='https://digitanzo.lk/jss/login.php';" value="Login Now"  target="_blank" />
	    </div>
    <!-- End header -->
