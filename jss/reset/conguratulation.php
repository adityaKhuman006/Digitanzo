...
<body id="contact" bgcolor="#ccc" class="inner_page" data-spy="scroll" data-target="#navbar-wd" data-offset="98">
    ...
    <!-- Start header -->
		...
		<h1 class="site-" data-lead-id="site-header-title">"Password updated. You can now login."</h1>
	</header>


	<div>
	     <input class="btn btn-primary" type="submit" onclick="location.href='https://digitanzo.lk/jss/login.php';" value="Login Now"  target="_blank" />
	    </div>
    <!-- End header -->
