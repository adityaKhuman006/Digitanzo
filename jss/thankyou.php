...
<body id="contact" bgcolor="#ccc" class="inner_page" data-spy="scroll" data-target="#navbar-wd" data-offset="98">
     ...
     <header class="top-header">
       ...
       <div class="container">
        <div class="row">
              <div class="col-lg-12">
           <div class="full">
                <h3>RECEIVED YOUR APPLICATION</h3>
	...
	<div class="main-content">
		...
		<p class="main-content__body" data-lead-id="main-content-body">We received your Details! You will receive your Register Code in 48 - 72 working hours.</p>
	</div>
    <!-- End header -->
