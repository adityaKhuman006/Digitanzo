                ...
                <table class="table table-bordered table-striped">
                      ...
                      <tbody>
                        <?php
                          ...
                          $check_users=$db->prepare("SELECT user_no,user_reg_id,user_name,user_rec_id,user_member,user_dir,regist_date FROM
                          (SELECT user_no,user_reg_id,user_name,user_rec_id,user_dir,user_member,regist_date,
                          CASE WHEN user_reg_id in ($user_rec_id) THEN @idlist := CONCAT(IFNULL(@idlist,''),',',user_reg_id)
                          ...
                          $check_users->bind_result($user_no,$user_reg_id,$user_name,$user_rec_id,$user_dir,$user_member,$regist_date);
                            $user_data=[];
                            $count=$user_member-$user_dir;
