        ...
        <div class="col-12">
          ...
          <div class="card">
            ...
            <?php
                    ...
                    if($user_name == 'admin')
                    {
                        $sql = "SELECT * FROM tbl_reg WHERE user_isdel = '0' or user_isdel = '100' order by user_no desc";
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    ...
                                    echo "<td>" . $row['refnum'] . "</td>";
                                       ...
                                       // echo "<td>" . $row['regist_date'] . "</td>";
                                        echo "<td>  <a href  = 'paidinfoc.php?id=". $row['user_no']."' class='fa fa-credit-card' style='font-size:36 px;color:blue' name='add'  title = 'ADD'></a> </td>";
